  ...
  return (
    <header className="header">
      <Link to="/" className="logo">
        <div className="logo-container"> {/* Nouveau conteneur */}
          ...
          <div className="logo-house">
            ...
            <div className="logo-rectangle">
              <svg width="6" height="17" viewBox="0 0 6 17" fill="none" xmlns="http://www.w3.org/2000/svg" transform="translate(0, 10)">
